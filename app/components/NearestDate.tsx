...
import NearestDateMobile from "./NearestDateMobile";
import { Slots } from "../utils/types";


type Props = {
  onQuickBook?: (slot: Slots) => void;
...
const NearestDate = ({ onQuickBook, refreshInterval = 0 }: Props) => {
  ...
  const [closest, setClosest] = useState<Slots | null>(null);
  ...
  const prettySlotLabel = (s: Slots | null) => {
  ...
  return (
    <div>
      ...
      <div
        className="fixed hidden md:block bottom-0 left-1/2 -translate-x-1/2 pointer-events-auto z-10"
